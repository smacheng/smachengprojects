...
import com.smacheng.service.CaptchaService;
...
public class LoginController {
    ...
    public String submit(String captcha,
            ...
            HttpSession session,
            Model model) {
    	String qqinfo = request.getParameter("qqloginflag");
...
//        memberService.update(member);
        ...
        System.out.println("loginsetsessionkey--->"+Member.PRINCIPAL_ATTRIBUTE_NAME);
        System.out.println("loginsetsessionvalue--->"+new Principal(member.getId(), username));
        session.setAttribute(Member.PRINCIPAL_ATTRIBUTE_NAME, new Principal(member.getId(), username));
        session.setAttribute("loginmember", new Principal(member.getId(), username));
