...
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/jquery-ui.custom.min.css" />
<!-- text fonts -->
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/ace-fonts.css" />
