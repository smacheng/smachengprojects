...
<html lang="en">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-3 center">
                                                    <span class="profile-picture">
                                                        <img class="editable img-responsive" alt="Alex's Avatar" id="avatar2" src="<%=request.getContextPath()%>/resources/avatars/profile-pic.jpg" />
                                                    </span>

                                                    <div class="space space-4"></div>

                                                    <a href="<%=request.getContextPath()%>/admin/employee/edit/${admin.id}" class="btn btn-sm btn-success">
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/js/datatables/jquery.dataTables.min.js"></script>
    <script type="text/javascript" src="<%=request.getContextPath()%>/js/datatables/jquery.dataTables.bootstrap.js"></script>
