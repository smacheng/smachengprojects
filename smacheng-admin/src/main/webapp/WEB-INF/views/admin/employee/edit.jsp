...
<html lang="en">
                                        ...
                                        <div id="profile" class="tab-pane active in">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-9">
                                                    <form class="form-horizontal" role="form" action="<%=request.getContextPath()%>/admin/employee/update" method="post">
                                                        <h4 class="blue">
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/datatables/jquery.dataTables.bootstrap.js"></script>
