...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8" />
        <title>smacheng</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0" />
        <%@include file="/WEB-INF/views/admin/common/css-ace.jsp"%>
        <link href="<%=request.getContextPath()%>/resources/css/datatables/dataTables.bootstrap.css" rel="stylesheet" type="text/css" />
        <link href="<%=request.getContextPath()%>/resources/css/datatables/datatables.css" rel="stylesheet" type="text/css" />
    </head>
    ...
    <body class="no-skin">
                        ...
                        <div class="page-header">
                            <h1>
                                ...
                                <label class="pull-right inline">
                                    <a href="<%=request.getContextPath()%>/admin/employee/add" class="btn btn-success" id="gritter-error"><i class="glyphicon glyphicon-plus"></i>  添加管理员</a>
                                </label>
                            </h1>
        ...
        <script src="<%=request.getContextPath()%>/resources/js/datatables/jquery.dataTables.bootstrap.js"></script>
        <script src="<%=request.getContextPath()%>/resources/js/mycommon/format.js" type="text/javascript"></script>
        ...
        <script type="text/javascript">
                            $(document).ready(function () {
                                ...
                                var myDataTable = $('#myDatatbles').dataTable({
                                    ...
                                    "searching": false,
                                    "dom": 'rtlip',
                                    "sAjaxSource": "<%=request.getContextPath()%>/admin/employee/getDatatables",
                                    "aoColumns": [
                                        {"mData": "id"},
                                        {"mData": "username"},
                                        {"mData": "email"},
                                    ...
                                    "aoColumnDefs": [{
                                            ...
                                            "mRender": function (username, type, row) {
                                                return "<a href='<%=request.getContextPath()%>/admin/employee/details/"+row['id'] +"'>"+username+"</a>";
                                            }
                                        },{
                                            "aTargets": [5],
