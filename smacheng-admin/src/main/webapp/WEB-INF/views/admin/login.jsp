                                ...
                                <div class="form-group input-group">
                                    ...
                                    <input type="text" class="form-control" id="captcha"
                                           ...
                                           style="cursor: pointer"> <img id="captchaImage"
                                                                  ...
                                                                  src="<%=request.getContextPath()%>/admin/common/captcha" />
                                    </span>
                                </div>
            ...
            $(document).ready(
                    function() {
                        ...
                        $captchaImage.click(function() {
                            $captchaImage.attr("src","<%=request.getContextPath()%>/admin/common/captcha?&timestamp=" + (new Date()).valueOf());
                        });
                    });
        </script>
