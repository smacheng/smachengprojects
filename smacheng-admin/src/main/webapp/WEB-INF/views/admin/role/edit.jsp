                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="tabbable">
                                    <ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab4">
                                        <li class="active">
                                            <a data-toggle="tab" href="#profile">角色编辑</a>
                                        </li>
                                    </ul>
                                    <div class="tab-content">
                                        <div id="profile" class="tab-pane active in">
                                            ...
                                            <!-- PAGE CONTENT BEGINS -->
                                            <form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/admin/role/update" method="post">
                                                <input type="hidden" name="id" value="${role.id}">
                                                <!-- #section:elements.form -->
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label no-padding-right" for="name">名称</label>
                                                    <div class="col-sm-9">
                                                        <input id="name" name="name"  value="${role.name}" class="col-xs-10 col-sm-5" type="text">
                                                    </div>
                                                </div>
                                                <div class="hr"></div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input id="description" name="description" value="${role.description}" class="col-xs-10 col-sm-5" type="text">
                                                    </div>
                                                </div>
                                                <div class="hr"></div>
                                                <!-- #section:角色列表循序 -->
                                                                ...
                                                                <label>
                                                                    <input name="authorities" class="ace ace-checkbox-2" value="admin:admin" type="checkbox" 
                                                                           <c:forEach items="${role.authorities}" var="authority">
                                                                               <c:if test="${fn:contains(authority, 'admin:admin')}">
                                                                                   checked
                                                                               </c:if>
                                                                           </c:forEach>
                                                                           >
                                                            ...
                                                            <div class="col-xs-3">
                                                                <label>
                                                                    <input name="authorities" class="ace ace-checkbox-2" value="admin:goods" type="checkbox" 
                                                                           <c:forEach items="${role.authorities}" var="authority">
                                                                               <c:if test="${fn:contains(authority, 'admin:goods')}">
                                                                                   checked
                                                                               </c:if>
                                                                           </c:forEach>
                                                                           >
                                                            ...
                                                            <div class="col-xs-3">
                                                                <label>
                                                                    <input name="authorities" class="ace ace-checkbox-2" value="admin:stock" type="checkbox"
                                                                           <c:forEach items="${role.authorities}" var="authority">
                                                                               <c:if test="${fn:contains(authority, 'admin:stock')}">
                                                                                   checked
                                                                               </c:if>
                                                                           </c:forEach>
                                                                           >
                                                            ...
                                                            <div class="col-xs-3">
                                                                <label>
                                                                    <input name="authorities" class="ace ace-checkbox-2" value="admin:parameter" type="checkbox"
                                                                           <c:forEach items="${role.authorities}" var="authority">
                                                                               <c:if test="${fn:contains(authority, 'admin:parameter')}">
                                                                                   checked
                                                                               </c:if>
                                                                           </c:forEach>
                                                                           >
                                                            ...
                                                            <div class="col-xs-3">
                                                                <label>
                                                                    <input name="authorities" class="ace ace-checkbox-2" value="admin:productCategory" type="checkbox"
                                                                           <c:forEach items="${role.authorities}" var="authority">
                                                                               <c:if test="${fn:contains(authority, 'admin:productCategory')}">
                                                                                   checked
                                                                               </c:if>
                                                                           </c:forEach>
                                                                           >
